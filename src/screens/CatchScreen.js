...
const CatchScreen = ({ setSelectedRainbowScreen, isRainbowGameStarted, setIsRainbowGameStarted }) => {
        ...
        if (tryCollision(newItem)) {
          ...
          setTimeout(() => {
            if (newItem.isPositive) {
              if (newItem.type === 'coin') setApplesAmount((prev) => prev + 1);
            } else {
  ...
  useEffect(() => {
    let timerId = null;
    if (!pauseModalVisible && !resultsModalVisible && isRainbowGameStarted) {
      timerId = setInterval(() => {
        if (!pauseModalVisible && !resultsModalVisible && isRainbowGameStarted) {
          spawnFood();
        }
  ...
  }, [pauseModalVisible, resultsModalVisible, isRainbowGameStarted]);
  ...
  return (
    <View>
        ...
        <ImageBackground source={require('../assets/images/rainbowGameImages/rainbowPreGameImage.png')} style={{ flex: 1, width: dimensions.width, height: dimensions.height }}>
          <SafeAreaView style={{
            ...
            <SafeAreaView style={{
              ...
              <Image
                source={require('../assets/images/rainbowGameImages/playerGameImage.png')}
                style={{
      ...
      >
        <ImageBackground source={require('../assets/images/rainbowGameImages/rainbowGameBg.png')} style={{ flex: 1, width: dimensions.width, height: dimensions.height }}>
